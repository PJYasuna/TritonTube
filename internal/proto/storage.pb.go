...
var file_proto_storage_proto_depIdxs = []int32{
	...
	1, // 3: tritontube.VideoStorageService.WriteFile:output_type -> tritontube.WriteFileResponse
	3, // 4: tritontube.VideoStorageService.ReadFile:output_type -> tritontube.ReadFileResponse
	5, // 5: tritontube.VideoStorageService.DeleteFile:output_type -> tritontube.DeleteFileResponse
